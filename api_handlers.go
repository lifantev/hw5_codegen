...
func (h* MyApi) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	switch r.URL.Path {
		case "/user/profile":
			res, err = h.handlerProfile(w, r)
		case "/user/create":
			res, err = h.handlerCreate(w, r)
		default:
...
func (h *MyApi) handlerProfile(w http.ResponseWriter, r *http.Request) (interface{}, error) {
...
func (h *MyApi) handlerCreate(w http.ResponseWriter, r *http.Request) (interface{}, error) {
...
func (h *OtherApi) handlerCreate(w http.ResponseWriter, r *http.Request) (interface{}, error) {
	if r.Header.Get("X-Auth") != "100500" {
		return nil, ApiError{http.StatusForbidden, fmt.Errorf("unauthorized")}
	}
	if r.Method != "POST" {
